document.addEventListener("DOMContentLoaded", function () {
  ...
  function addToCart(productName, price) {
    ...
    window.location.href = 'added.html';  // Redirect to the "Item Added" confirmation page
  }
  ...
  function loadCart() {
    ...
    cartList.innerHTML = '';  // Clear cart items
  ...
  // Load checkout summary on checkout page
  function loadCheckout() {
    ...
    checkoutList.innerHTML = '';  // Clear items in the checkout
    ...
    form.addEventListener('submit', function (e) {
      ...
      emailjs.sendForm('YOUR_SERVICE_ID', 'YOUR_TEMPLATE_ID', this)
        .then(function () {
          ...
          localStorage.removeItem('cart'); // Clear the cart after submitting the order
        }, function (error) {
